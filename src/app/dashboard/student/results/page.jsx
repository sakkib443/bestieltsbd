...
export default function StudentResults() {
    ...
    const handleDownloadPDF = async () => {
        ...
        try {
            ...
            doc.text("Best IELTS BD — Official Score Report", margin, 32);
            ...
            doc.setFontSize(7);
            doc.setTextColor(...gray);
            doc.text("This is a computer-generated report from Best IELTS BD Exam Portal.", margin, footerY);
            doc.text(
            ...
            doc.setFontSize(7);
            doc.setTextColor(...primary);
            const footerRight = "www.bestieltsbd.com";
